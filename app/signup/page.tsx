    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-200 mt-2">Join the sustainable fashion community</p>
        </div>
        ...
        <Card className="backdrop-blur-lg bg-white/80 dark:bg-gray-900/80 border border-green-200/50 dark:border-green-800/50 shadow-2xl">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600 dark:text-gray-300">Sign up to start swapping clothes and earning points</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white shadow-lg" disabled={isPending || !agreeToTerms}>
